...
class Net(nn.Module):
    ...
    def multiview_fine_point_matching(self, end_points, fps_idx_m, fps_idx_o):
        ...
        # geo_embedding_o = self.geo_embedding(torch.cat([bg_point, dense_po[:, fps_idx_o]], dim=1))
    ...
    def singleview_coarse_point_matching(self, end_points):
        ...
        return end_points, fps_idx_m, fps_idx_o
